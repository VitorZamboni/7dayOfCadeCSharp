...
namespace Tamagotchi
{
    public class TamagotchiController
    {
        ...
        private void MenuAdocao()
        {
            ...
            if (especieMascote.ToUpper() != "BULBASAUR" && especieMascote.ToUpper() != "IVYSAUR")
            {
                Console.WriteLine("Mascote invalido! Você escreveu o nome certo?");
                MenuAdocao();
            }
            else
            {
        ...
        private void MenuInteracao()
        {
            ...
            {
                Console.WriteLine("Você ainda não possui mascotes");
                Jogar();
            }
